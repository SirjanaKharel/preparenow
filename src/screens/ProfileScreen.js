    ...
    <View style={styles.container}>
      ...
      <Modal visible={helpVisible} animationType="fade" transparent onRequestClose={() => setHelpVisible(false)}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={{ fontSize: 15, color: '#374151', marginBottom: 18, textAlign: 'center' }}>
              For assistance, FAQs, or to contact support, please email us at support@preparenow.app or visit our website. We're here to help you with any issues or questions!
            </Text>
            <TouchableOpacity style={styles.helpCloseBtn} onPress={() => setHelpVisible(false)}>
              <Text style={styles.helpCloseBtnText}>Close</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.card}>
          ...
          {[
            { label: 'Help & Support',     onPress: () => setHelpVisible(true) },

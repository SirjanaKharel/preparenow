...
// Constants for alert types and keywords
...
// Sub-components for alert cards and modals
...
export default function AlertsScreen({ navigation }) {
  ...
  // Load alerts and events from services
  ...
  // Listen for real-time alert changes
  useEffect(() => {
  ...
  // IDs of currently active zones
  const activeZoneIds = new Set(activeZones.map(z => z.id));

  // List of critical alerts to display

...
// Developer settings screen for testing location and clearing data
export default function DeveloperSettingsScreen({ navigation }) {
  ...
  // Set a fake location for testing
  ...
  // Apply the current test coordinates
  const handleUpdateLocation = async () => {
    await applyLocation(testLat, testLon);
  };

  // Clear all stored zone events
  ...
  // Find and use the nearest disaster zone
  ...
  // Example test zones for quick selection
  const TEST_ZONES = [
  ...
  // Render the developer settings UI
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        <View style={styles.row}>
          ...
          <Switch testID="devModeSwitch" value={devMode} onValueChange={handleToggle} />
        </View>
      </View>

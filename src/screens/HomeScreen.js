...
// Radius to consider a zone "nearby"
const ZONE_RADIUS_KM = 5;


// Get label and color for preparedness percent
...
// Build alert objects from nearby zones
...
export default function HomeScreen({ navigation }) {
  ...
  // Manually check zones and update location
  ...
  // Update live alerts when nearby zones change
  useEffect(() => {
  ...
  // Start monitoring and request permissions
  ...
  // Handler to call emergency contact
